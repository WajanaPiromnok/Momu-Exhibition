...
public static class SaveLoad
{
    ...
    public static PlayerData LoadPlayerDataPlayerPrefs() => new PlayerData(new Character(PlayerPrefs.GetInt("skin"), PlayerPrefs.GetInt("head"), PlayerPrefs.GetInt("top"), PlayerPrefs.GetInt("pants"), PlayerPrefs.GetInt("shoes")));
