...
// {
    ...
    {
        public MeshRenderer rendUp;
        public MeshRenderer rendDown;
        ...
        Vector3 InterpolatePosition(DataPoint start, DataPoint goal, Vector3 currentPosition)
        {
            ...
            else if (start != null)
            {
                ...
                return Vector3.Lerp(currentPosition, goal.localPosition, Time.deltaTime*6);
            }
        ...
        void Update()
        {
            ...
            if (isClient)
            {
                    ...
                    if (Time.time - lastClientSendTime >= syncInterval)
                    {
                        if (HasEitherMovedRotatedScaled())
                        {
                            ...
                            using (PooledNetworkWriter writer = NetworkWriterPool.GetWriter())
                            {
                                ...
                                // send to server
                                if(rendUp != null) rendUp.enabled = true;
                ...
                if (!IsClientWithAuthority)
                {
                    ...
                    if (goal != null)
                    {
                        if(rendDown != null) rendDown.enabled = true;
