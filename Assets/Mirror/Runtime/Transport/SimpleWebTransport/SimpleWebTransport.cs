...
namespace Mirror.SimpleWeb
{
    ...
    public class SimpleWebTransport : Transport
    {
        ...
        public override void ClientConnect(string hostname)
        {
            ...
            // Debug.Log("Actually connecting with wss " + clientUseWss.ToString() + " " + sslEnabled.ToString());
        ...
        public override void ServerStart()
        {
            ...
            Debug.Log("Actually starting server with wss " + clientUseWss.ToString() + " " + sslEnabled.ToString());
